...
void TestQgsGeometryV2ImportExport::testCircularString_data()
{
  ...
  circularStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, false ) << QgsPointV2( 1.4, 0.5, -1.6, false ) << QgsPointV2( 1.7, 1.8, 2.9, false ) );
  ...
  circularStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, true ) << QgsPointV2( 1.4, 0.5, -1.6, true ) << QgsPointV2( 1.7, 1.8, 2.9, true ) );
  ...
  circularStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, 2.4 ) << QgsPointV2( 1.5, 0.6, -1.7, 3.8 ) << QgsPointV2( 1.9, 1.1, 2.2, 4.3 ) );
...
void TestQgsGeometryV2ImportExport::testLineString_data()
{
  ...
  lineStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, false ) << QgsPointV2( 1.4, 0.5, -1.6, false ) << QgsPointV2( 1.7, 1.8, 2.9, false ) );
  ...
  lineStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, true ) << QgsPointV2( 1.4, 0.5, -1.6, true ) << QgsPointV2( 1.7, 1.8, 2.9, true ) );
  ...
  lineStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 0.3, 2.4 ) << QgsPointV2( 1.5, 0.6, -1.7, 3.8 ) << QgsPointV2( 1.9, 1.1, 2.2, 4.3 ) );
...
void TestQgsGeometryV2ImportExport::testCompoundCurve_data()
{
  ...
  QgsLineStringV2* lineStringZ = new QgsLineStringV2();
  lineStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, false ) << QgsPointV2( 1.3, 0.4, 6.2, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) );
  compoundCurveZ->addCurve( lineStringZ );
  QgsCircularStringV2* circularStringZ = new QgsCircularStringV2();
  circularStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 6.7, 6.6, 3.1, false ) << QgsPointV2( 2.2, 9.4, 4.3, false ) );
  ...
  QgsLineStringV2* lineStringM = new QgsLineStringV2();
  lineStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, true ) << QgsPointV2( 1.3, 0.4, 6.2, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) );
  compoundCurveM->addCurve( lineStringM );
  QgsCircularStringV2* circularStringM = new QgsCircularStringV2();
  circularStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 6.7, 6.6, 3.1, true ) << QgsPointV2( 2.2, 9.4, 4.3, true ) );
  ...
  QgsLineStringV2* lineStringZM = new QgsLineStringV2();
  lineStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) << QgsPointV2( 1.3, 0.4, 6.2, 1.5 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) );
  compoundCurveZM->addCurve( lineStringZM );
  QgsCircularStringV2* circularStringZM = new QgsCircularStringV2();
  circularStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 6.7, 6.6, 3.1, 2.6 ) << QgsPointV2( 2.2, 9.4, 4.3, 8.5 ) );
...
void TestQgsGeometryV2ImportExport::testPoint_data()
{
  ...
  << reinterpret_cast<void*>( new QgsPointV2( 0.1, 0.2, 0.3, false ) );
  ...
  << reinterpret_cast<void*>( new QgsPointV2( 0.1, 0.2, 0.3, true ) );
  ...
  << reinterpret_cast<void*>( new QgsPointV2( 0.1, 0.2, 0.3, 2.4 ) );
}
...
void TestQgsGeometryV2ImportExport::testMultiLineString_data()
{
  ...
  lineString1Z->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, false ) << QgsPointV2( 1.3, 0.4, 6.2, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) );
  multiLineStringZ->addGeometry( lineString1Z );
  QgsLineStringV2* lineString2Z = new QgsLineStringV2();
  lineString2Z->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 6.7, 6.6, 3.1, false ) << QgsPointV2( 2.2, 9.4, 4.3, false ) );
  ...
  lineString1M->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, true ) << QgsPointV2( 1.3, 0.4, 6.2, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) );
  multiLineStringM->addGeometry( lineString1M );
  QgsLineStringV2* lineString2M = new QgsLineStringV2();
  lineString2M->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 6.7, 6.6, 3.1, true ) << QgsPointV2( 2.2, 9.4, 4.3, true ) );
  ...
  lineString1ZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) << QgsPointV2( 1.3, 0.4, 6.2, 1.5 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) );
  multiLineStringZM->addGeometry( lineString1ZM );
  QgsLineStringV2* lineString2ZM = new QgsLineStringV2();
  lineString2ZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 6.7, 6.6, 3.1, 2.6 ) << QgsPointV2( 2.2, 9.4, 4.3, 8.5 ) );
...
void TestQgsGeometryV2ImportExport::testMultiPoint_data()
{
  ...
  multiPointZ->addGeometry( new QgsPointV2( 0.1, 0.2, 6.3, false ) );
  multiPointZ->addGeometry( new QgsPointV2( 1.3, 0.4, 6.4, false ) );
  ...
  multiPointM->addGeometry( new QgsPointV2( 0.1, 0.2, 6.3, true ) );
  multiPointM->addGeometry( new QgsPointV2( 1.3, 0.4, 6.4, true ) );
  ...
  multiPointZM->addGeometry( new QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) );
  multiPointZM->addGeometry( new QgsPointV2( 1.3, 0.4, 6.4, 1.5 ) );
...
void TestQgsGeometryV2ImportExport::testMultiPolygon_data()
{
  ...
  QgsLineStringV2* lineString1Z = new QgsLineStringV2();
  lineString1Z->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, false ) << QgsPointV2( 1.3, 0.4, 6.2, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 0.1, 0.2, 6.3, false ) );
  polygon1Z->setExteriorRing( lineString1Z );
  polygon2Z->setExteriorRing( lineString1Z->clone() );
  QgsLineStringV2* lineString2Z = new QgsLineStringV2();
  lineString2Z->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 6.7, 6.6, 3.1, false ) << QgsPointV2( 2.2, 9.4, 4.3, false ) << QgsPointV2( 5.3, 6.3, 9.3, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) );
  ...
  QgsLineStringV2* lineString1M = new QgsLineStringV2();
  lineString1M->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, true ) << QgsPointV2( 1.3, 0.4, 6.2, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 0.1, 0.2, 6.3, true ) );
  polygon1M->setExteriorRing( lineString1M );
  polygon2M->setExteriorRing( lineString1M->clone() );
  QgsLineStringV2* lineString2M = new QgsLineStringV2();
  lineString2M->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 6.7, 6.6, 3.1, true ) << QgsPointV2( 2.2, 9.4, 4.3, true ) << QgsPointV2( 5.3, 6.3, 9.3, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) );
  ...
  QgsLineStringV2* lineString1ZM = new QgsLineStringV2();
  lineString1ZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) << QgsPointV2( 1.3, 0.4, 6.2, 1.5 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) );
  polygon1ZM->setExteriorRing( lineString1ZM );
  polygon2ZM->setExteriorRing( lineString1ZM->clone() );
  QgsLineStringV2* lineString2ZM = new QgsLineStringV2();
  lineString2ZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 6.7, 6.6, 3.1, 2.6 ) << QgsPointV2( 2.2, 9.4, 4.3, 8.5 ) << QgsPointV2( 5.3, 6.3, 9.3, 2.1 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) );
...
void TestQgsGeometryV2ImportExport::testCurvePolygon_data()
{
  ...
  QgsCurvePolygonV2* curvePolygonZ = new QgsCurvePolygonV2();
  QgsLineStringV2* lineStringZ = new QgsLineStringV2();
  lineStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, false ) << QgsPointV2( 1.3, 0.4, 6.2, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 0.1, 0.2, 6.3, false ) );
  curvePolygonZ->setExteriorRing( lineStringZ );
  QgsCircularStringV2* circularStringZ = new QgsCircularStringV2();
  circularStringZ->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, false ) << QgsPointV2( 6.7, 6.6, 3.1, false ) << QgsPointV2( 2.2, 9.4, 4.3, false ) << QgsPointV2( 5.3, 6.3, 9.3, false ) << QgsPointV2( 1.5, 1.6, 3.6, false ) );
  ...
  QgsCurvePolygonV2* curvePolygonM = new QgsCurvePolygonV2();
  QgsLineStringV2* lineStringM = new QgsLineStringV2();
  lineStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, true ) << QgsPointV2( 1.3, 0.4, 6.2, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 0.1, 0.2, 6.3, true ) );
  curvePolygonM->setExteriorRing( lineStringM );
  QgsCircularStringV2* circularStringM = new QgsCircularStringV2();
  circularStringM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, true ) << QgsPointV2( 6.7, 6.6, 3.1, true ) << QgsPointV2( 2.2, 9.4, 4.3, true ) << QgsPointV2( 5.3, 6.3, 9.3, true ) << QgsPointV2( 1.5, 1.6, 3.6, true ) );
  ...
  QgsCurvePolygonV2* curvePolygonZM = new QgsCurvePolygonV2();
  QgsLineStringV2* lineStringZM = new QgsLineStringV2();
  lineStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) << QgsPointV2( 1.3, 0.4, 6.2, 1.5 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 0.1, 0.2, 6.3, 2.3 ) );
  curvePolygonZM->setExteriorRing( lineStringZM );
  QgsCircularStringV2* circularStringZM = new QgsCircularStringV2();
  circularStringZM->setPoints( QList<QgsPointV2>() << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) << QgsPointV2( 6.7, 6.6, 3.1, 2.6 ) << QgsPointV2( 2.2, 9.4, 4.3, 8.5 ) << QgsPointV2( 5.3, 6.3, 9.3, 2.1 ) << QgsPointV2( 1.5, 1.6, 3.6, 7.3 ) );
