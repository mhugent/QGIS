...
bool QgsOgrProviderMetadata::styleExists( const QString &uri, const QString &styleId, QString &errorCause )
{
  ...
  QgsOgrLayerUniquePtr userLayer = QgsOgrUtils::LoadDataSourceAndLayer( uri, errorCause );
  if ( !userLayer )
    return false;
...
bool QgsOgrProviderMetadata::deleteStyleById( const QString &uri, const QString &styleId, QString &errCause )
{
  ...
  QgsOgrLayerUniquePtr userLayer = QgsOgrUtils::LoadDataSourceAndLayer( uri, errCause );
  if ( !userLayer )
    return false;
