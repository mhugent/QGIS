...
{
  public:
    void renderPolygon( const QPolygonF& points, QList<QPolygonF>* rings, QgsSymbolV2RenderContext& context ); //for compatibility
    virtual void renderPolygon( const QgsGeometry* geom, QgsSymbolV2RenderContext& context ) = 0;
