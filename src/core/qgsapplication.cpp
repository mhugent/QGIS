...
const char* QgsApplication::QGIS_ORGANIZATION_NAME = "NIWA";
const char* QgsApplication::QGIS_ORGANIZATION_DOMAIN = "niwa.co.nz";
const char* QgsApplication::QGIS_APPLICATION_NAME = "NIWA Quantum Map";
