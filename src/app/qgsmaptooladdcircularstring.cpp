...
QgsMapToolAddCircularString::QgsMapToolAddCircularString( QgsMapToolAddFeature* parentTool, QgsMapCanvas* canvas ): QgsMapToolCapture( canvas ), mParentTool( parentTool )
{
